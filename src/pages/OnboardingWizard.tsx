    ...
    <div style={{ maxWidth: "560px", margin: "0 auto", padding: "24px 20px 120px" }}>
      ...
      >
        {STEPS.map((s, i) => (
          <div key={s} style={{
            ...
            background: step === s ? "#14B8A6" : stepIndex > i ? "#14B8A688" : "#1A1A2E",
          }} />
        ))}
      </div>
      ...
      {step === "intro" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div>
            <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>Benvenuto</div>
      ...
      {step === "apiKey" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div>
            <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>Step 1 · Coach AI</div>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ marginTop: MULTI_PROVIDER_UI ? "12px" : "0", fontSize: "12px", color: "#94A3B8", lineHeight: 1.5 }}>
              Ottieni la chiave gratis su <a href={PROVIDER_HELP[provider].url} target="_blank" rel="noreferrer" style={{ color: "#14B8A6" }}>{PROVIDER_HELP[provider].label}</a>
            </div>

            <div style={{ marginTop: "12px" }}>
              <label htmlFor={fid("apiKey")} style={labelStyle}>
                Chiave API <span style={{ color: "#14B8A6" }} aria-label="obbligatoria">*</span>
              </label>
      ...
      {step === "profile" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div>
            <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>Step 2 · Profilo</div>
            <h2 style={{ fontSize: "26px", fontWeight: 900, margin: "6px 0 4px", letterSpacing: "-0.03em" }}>Chi sei</h2>
            <p style={{ color: "#94A3B8", fontSize: "14px", margin: 0 }}>Mi servono alcuni dati per costruire un piano realistico. I campi con <span style={{ color: "#14B8A6" }}>*</span> sono obbligatori.</p>
          </div>
            ...
            {(() => {
              ...
              return (
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
                  <div>
                    <label htmlFor={fid("age")} style={labelStyle}>Età <span style={{ color: "#14B8A6" }} aria-label="obbligatorio">*</span></label>
                  ...
                  <div>
                    <label htmlFor={fid("weight")} style={labelStyle}>Peso (kg) <span style={{ color: "#14B8A6" }} aria-label="obbligatorio">*</span></label>
                  ...
                  <div>
                    <label htmlFor={fid("height")} style={labelStyle}>Altezza (cm) <span style={{ color: "#14B8A6" }} aria-label="obbligatorio">*</span></label>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              {EXP_OPTIONS.map(o => (
                <button key={o.v} onClick={() => setProfile(p => ({ ...p, experience: o.v }))} style={{
                  ...
                  background: profile.experience === o.v ? "#14B8A622" : "#1A1A2E",
                  border: profile.experience === o.v ? "1px solid #14B8A6" : "1px solid rgba(255,255,255,0.06)",
      ...
      {step === "goals" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div>
            <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>Step 5 · Obiettivi</div>
                ...
                {([1, 2, 3] as const).filter(n => n <= 3 - goals.length).map(n => {
                  ...
                  return (
                    <button key={n} onClick={tryChangeCount} style={{
                      flex: 1, padding: "10px",
                      background: goalsCount === n ? "#14B8A622" : "#1A1A2E",
                      border: goalsCount === n ? "1px solid #14B8A6" : "1px solid rgba(255,255,255,0.08)",
                      borderRadius: "10px", color: goalsCount === n ? "#14B8A6" : "#CBD5E1",
      ...
      {step === "disclaimer" && (() => {
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div>
            <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>Step 6 · Sicurezza</div>
      ...
      {step === "plan" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div>
            <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>Step 7 · Piano</div>
          ...
          {plan && (
            <>
              <div style={{ ...cardStyle, borderLeft: "3px solid #14B8A6" }}>
              ...
              {plan.weeks.map(w => (
                <div key={w.weekNumber} style={cardStyle}>
                  <div style={{ fontSize: "11px", fontWeight: 700, color: "#14B8A6", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "4px" }}>Settimana {w.weekNumber}</div>
                    ...
                    {w.sessions.map((s, i) => (
                      <div key={i} style={{ padding: "10px 12px", background: "#1A1A2E", borderRadius: "10px", fontSize: "13px" }}>
                        <div style={{ display: "flex", gap: "8px", alignItems: "baseline", marginBottom: "4px" }}>
                          <span style={{ fontWeight: 700, textTransform: "uppercase", color: "#14B8A6", fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", minWidth: "32px" }}>{s.day}</span>
