  ...
  return (
    <div style={{ maxWidth: "560px", margin: "0 auto", padding: "24px 20px" }}>
      <div style={{ marginBottom: "16px" }}>
        <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>Trend</div>
      ...
      {loading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          {/* ═══ SEZIONE ALLENAMENTI ═══ */}
          <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.12em", color: "#14B8A6", textTransform: "uppercase", marginTop: "8px", paddingLeft: "4px" }}>
            🏋️ Dati Allenamenti
          </div>

          <div style={cardStyle}>
            <SectionHeader title="Volume allenamento" hint="minuti/die" color="#14B8A6" />
            <Sparkline points={series.dailyVolume} width={width - 32} color="#14B8A6" unit="′" />
          </div>
          ...
          {series.hasRunningData && (
            <>
              <div style={{ ...cardStyle, background: "#1A1A2E", borderLeft: "3px solid #14B8A6" }}>
                <div style={{ fontSize: "11px", fontWeight: 700, color: "#14B8A6", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                  🏃 Corsa — progressione
                </div>
              ...
              {series.runPaceSeries.some(p => p?.value != null) && (
                <div style={cardStyle}>
                  <SectionHeader title="Passo medio" hint="min:sec/km — basso = veloce, alto = lento" color="#14B8A6" />
                  <Sparkline
                    ...
                    return (
                      <div key={type} style={{ fontSize: "12px" }}>
                        ...
                        <div style={{ height: "6px", background: "#0F172A", borderRadius: "3px", overflow: "hidden" }}>
                          <div style={{ height: "100%", width: `${pct}%`, background: "#14B8A6", transition: "width 0.3s ease" }} />
                        </div>
                      </div>
                    );
                  })}
