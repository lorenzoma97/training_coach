...
- "PRESCRIZIONE TARGET" (blocco numerico iniettato sopra): è la legge. Il VOLUME SETTIMANALE TOTALE del piano (somma di tutte le durate sessione) DEVE essere nel range prescritto. Sotto -30% dal target = piano REJECTED. Distribuisci il volume tra i giorni allenabili, NON sotto-prescrivere "per stare sicuro".
