...
const WORKOUT_TYPES = [
  {
    id: "corsa", icon: "🏃", label: "Corsa", color: "#14B8A6",
    fields: [
        ...
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          <div style={{ padding: "16px 24px 10px", background: "linear-gradient(180deg, #16213E 0%, #0B0F1A 100%)" }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: "10px", flexWrap: "wrap" }}>
              <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.15em", color: "#14B8A6", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>
                Diario · Oggi
              </div>
              {todayData && (
                        ...
                        {wg.dates.map(date => {
                          ...
                          return (
                            <button key={date} onClick={() => openDetail(date)} style={{
                              ...
                              border: isToday ? "1px solid #14B8A633" : "1px solid rgba(255,255,255,0.04)",
                    ...
                    return (
                      <div key={f.key}>
                        <div style={{ display: "flex", gap: "6px", marginBottom: "4px", alignItems: "center" }}>
                          ...
                          {f.required && <span style={{ color: "#14B8A6", fontSize: "10px" }} aria-label="obbligatorio">●</span>}
                        </div>
