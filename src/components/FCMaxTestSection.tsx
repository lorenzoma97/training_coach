...
export default function FCMaxTestSection() {
  ...
  return (
    <div style={{
      background: "#1A1A2E",
      border: `1px solid ${hasTest ? "#22C55E44" : "#14B8A644"}`,
      borderRadius: "10px",
      padding: "14px",
    }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
        <div>
          <div style={{ color: hasTest ? "#22C55E" : "#14B8A6", fontWeight: 700, fontSize: "13px" }}>
        ...
        <button onClick={() => setExpanded(e => !e)} style={{
          padding: "8px 14px",
          background: hasTest ? "transparent" : "linear-gradient(135deg, #14B8A6 0%, #0D9488 100%)",
