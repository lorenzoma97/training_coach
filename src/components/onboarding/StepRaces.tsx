    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      {hasAnyRace && (
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {draft.races.map(r => (
            <div key={r.id} style={{ ...cardStyle, borderLeft: `3px solid ${r.priority === "A" ? "#E8553A" : r.priority === "B" ? "#F59E0B" : "#64748B"}` }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "8px" }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: "11px", color: r.priority === "A" ? "#E8553A" : "#94A3B8", fontWeight: 700, letterSpacing: "0.08em", marginBottom: "4px" }}>
              ...
              return (
                <label
                  ...
                  style={{
                    ...
                    background: checked ? "#E8553A22" : "#1A1A2E",
                    border: checked ? "1px solid #E8553A" : "1px solid rgba(255,255,255,0.08)",
                    borderRadius: "10px", cursor: "pointer",
                    color: checked ? "#E8553A" : "#CBD5E1",
                  }}
                >
                  <input
                    type="radio"
                    ...
                    style={{ accentColor: "#E8553A", marginBottom: "2px" }}
                  />
                  <span style={{ fontWeight: 700, fontSize: "13px" }}>{PRIORITY_LABELS[p].label}</span>
                  <span style={{ fontSize: "11px", color: checked ? "#E8553A" : "#94A3B8", lineHeight: 1.3 }}>
