  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
      ...
      {goalsChanged && hasApiKey() && goals.length > 0 && (
        <div style={{
          background: "#14B8A615", border: "1px solid #14B8A666",
          borderRadius: "12px", padding: "12px 14px",
          display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap",
        }}>
          <div style={{ flex: 1, minWidth: "160px" }}>
            <div style={{ fontSize: "12px", fontWeight: 700, color: "#14B8A6", marginBottom: "2px" }}>
          ...
          <button
            ...
            style={{
              padding: "10px 16px",
              background: regenerating ? "#1E293B" : "linear-gradient(135deg, #14B8A6 0%, #0D9488 100%)",
              border: "none", borderRadius: "10px", color: "#FFF",
      ...
      {goals.map(g => {
        ...
        const statusColor = g.status === "achieved" ? "#22C55E" : g.status === "archived" ? "#64748B" : "#14B8A6";
              ...
              <>
                ...
                <details style={{ marginTop: "6px" }}>
                  ...
                  <div style={{ display: "flex", gap: "6px", flexWrap: "wrap", marginTop: "8px" }}>
                    ...
                    {g.status === "archived" && (
                      <button onClick={() => toggleStatus(g.id, "active")} style={{ ...ghostBtn, padding: "8px 12px", minHeight: "36px", fontSize: "12px", borderColor: "#14B8A666", color: "#14B8A6" }}>Riattiva</button>
                    )}
                  </div>
                </details>
              </>
      ...
      {adding && (
        <div style={{ ...cardStyle, borderLeft: "3px solid #14B8A6" }}>
          <div style={{ fontSize: "11px", fontWeight: 700, color: "#14B8A6", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "8px" }}>
            Nuovo obiettivo
          </div>
          <textarea
      ...
      {!adding && canAdd && (
        <button onClick={startAdd} style={{ ...ghostBtn, alignSelf: "flex-start", borderStyle: "dashed", color: "#14B8A6", borderColor: "#14B8A666" }}>
          + Aggiungi obiettivo
        </button>
      )}
